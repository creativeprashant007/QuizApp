...
const UserFormScreen = (props: any) => {
          ...
          <View style={styles.form}>
            ...
            <View style={styles.formControl}>
              ...
              {isagevalid === 2 ? (
                ...
                parseInt(age) <= 40 &&
                age.trim().length > 0 ? null : (
                <Text>Enter age between 21 and 40</Text>
              )}
            </View>
          </View>
